...
import com.algaworks.algashop.ordering.core.domain.model.shopping.ShoppingCartTestDataBuilder;
...
class ShoppingCartUpdateProviderIT {
    ...
    @Autowired
    public ShoppingCartUpdateProviderIT(ShoppingCartsPersistenceProvider persistenceProvider, CustomersPersistenceProvider customersPersistenceProvider, ShoppingCartPersistenceEntityRepository entityRepository, ShoppingCartUpdateProvider shoppingCartUpdateProvider) {
